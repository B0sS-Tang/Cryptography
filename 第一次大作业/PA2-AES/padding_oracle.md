...
def padding_oracle_bug(ct):
    ...
    for chunk_pos in range(len(ct_list)-1):
        ...
        for iv_byte_pos in range(AES.block_size-1,-1,-1):
            ...
            if iv_byte_pos != AES.block_size-1:
...
![image-20211007154606170](/home/rean/.config/Typora/typora-user-images/image-20211007154606170.png)